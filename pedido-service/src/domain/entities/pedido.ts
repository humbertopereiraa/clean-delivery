...
export type PedidoStatus = "preparando" | "pronto" | "em_entrega" | "entregue"
...
export default class Pedido {
  ...
  constructor(id: string, clienteId: string, enderecoEntrega: EnderecoEntrega, itens: ItensPedido[], valorEntrega: number, status: PedidoStatus, criadoEm?: Date, atualizadoEm?: Date) {
    this._id = id?.trim()
  ...
  get status(): PedidoStatus { return this._status }
  ...
  private validar(): void {
    ...
    const statusValidos: PedidoStatus[] = ["preparando", "pronto", "em_entrega", "entregue"]
